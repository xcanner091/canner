...
var SUPPORTED_LANGUAGES = {
 ...
 "limit-fps": "Limit FPS",
 "load-failed-message": "Failed to run LobbyGeek Please Refresh",
  ...
  items: [
   ($parent) => {
    ...
    this.$btnGlobalReload = createButton({
     ...
     tabindex: 0
    }, CE("label", !0, t("suggest-settings")), CE("span", !1, "❯")), this.$btnSuggestion.addEventListener("click", SuggestionsSetting.renderSuggestions.bind(this)), topButtons.push(this.$btnSuggestion);
    let $div = CE("div", {
